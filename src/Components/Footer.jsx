      ...
      <div className="flex flex-col sm:flex-row  justify-center items-start w-[90%] mx-auto gap-10">
        ...
        <div className="w-full sm:w-1/2 md:w-1/4 text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-start gap-4 ">
            <a
              href="#"
              className="text-[#c9c9c9] hover:text-blue-600 transition-colors"
            >
              <FaFacebookF />
            </a>
            <a
              href="#"
              className="text-[#c9c9c9] hover:text-blue-400 transition-colors"
            >
              <FaTwitter />
            </a>
            <a
              href="#"
              className="text-[#c9c9c9] hover:text-pink-500 transition-colors"
            >
              <FaInstagram />
            </a>
          </div>
